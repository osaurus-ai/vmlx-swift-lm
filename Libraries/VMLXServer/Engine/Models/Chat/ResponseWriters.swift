...
public class SSEResponseWriter: ResponseWriter {

    public func writeHeaders(_ context: ChannelHandlerContext, extraHeaders: [(String, String)]? = nil) {
    ...
    @inline(__always)
    public func writeToolCallStart(
        callId: String,
        functionName: String,
        index: Int = 0,
        model: String,
    ...
    @inline(__always)
    public func writeToolCallArgumentsDelta(
        callId: String,
        index: Int,
    ...
    @inline(__always)
    public func writeFinishWithReason(
        _ reason: String,
        model: String,
        responseId: String,
        created: Int,
    ...
    public func writeError(_ message: String, context: ChannelHandlerContext) {
    ...
    public func writeEnd(_ context: ChannelHandlerContext) {
    ...
    public func writePing(_ context: ChannelHandlerContext) {
...
public class NDJSONResponseWriter: ResponseWriter {
    public func writeHeaders(_ context: ChannelHandlerContext, extraHeaders: [(String, String)]? = nil) {
        var head = HTTPResponseHead(version: .http1_1, status: .ok)
        var headers = HTTPHeaders()
...
public class AnthropicSSEResponseWriter {
    ...
    public func writeTextBlockStart(context: ChannelHandlerContext) {
    ...
    @inline(__always)
    public func writeTextDelta(_ text: String, context: ChannelHandlerContext) {
    ...
    public func writeBlockStop(context: ChannelHandlerContext) {
    ...
    /// are no-ops.
    public func writeThinkingBlockStart(context: ChannelHandlerContext) {
    ...
    @inline(__always)
    public func writeThinkingDelta(_ thinking: String, context: ChannelHandlerContext) {
    ...
    public func setOutputTokens(_ tokenCount: Int) {
        outputTokens = max(0, tokenCount)
    }

    /// Write tool_use block start
    public func writeToolUseBlockStart(
        toolId: String,
        toolName: String,
        context: ChannelHandlerContext
    ) {
    ...
    @inline(__always)
    public func writeToolInputDelta(_ partialJson: String, context: ChannelHandlerContext) {
    ...
    public func writeMessageDelta(stopReason: String, context: ChannelHandlerContext) {
    ...
    public func writeMessageStop(context: ChannelHandlerContext) {
    ...
    public func writeFinish(stopReason: String, context: ChannelHandlerContext) {
...
public class OpenResponsesSSEWriter {
    ...
    public func writeResponseCreated(
        responseId: String,
        model: String,
        inputTokens: Int,
        context: ChannelHandlerContext
    ...
    public func writeResponseInProgress(context: ChannelHandlerContext) {
        let response = OpenResponsesResponse(
            id: responseId,
            createdAt: Int(Date().timeIntervalSince1970),
            status: .inProgress,
    ...
    public func writeMessageItemAdded(itemId: String, context: ChannelHandlerContext) {
    ...
    public func writeContentPartAdded(context: ChannelHandlerContext) {
    ...
    public func writeReasoningItemAdded(itemId: String, context: ChannelHandlerContext) {
    ...
    @inline(__always)
    public func writeReasoningDelta(
        _ text: String,
        itemId: String,
        context: ChannelHandlerContext
    ) {
    ...
    public func writeReasoningItemDone(context: ChannelHandlerContext) {
        guard hasOpenReasoningItem else { return }
    ...
    public func writeTextDone(context: ChannelHandlerContext) {
    ...
    public func writeMessageItemDone(context: ChannelHandlerContext) {
        let messageItem = OpenResponsesOutputMessage(
            id: currentItemId,
            status: .completed,
    ...
    public func writeFunctionCallItemAdded(
        itemId: String,
        callId: String,
        name: String,
        context: ChannelHandlerContext
    ...
    @inline(__always)
    public func writeFunctionCallArgumentsDelta(
        callId: String,
        delta: String,
        context: ChannelHandlerContext
    ) {
    ...
    public func writeFunctionCallArgumentsDone(
        callId: String,
        context: ChannelHandlerContext
    ) {
    ...
    public func writeFunctionCallItemDone(
        callId: String,
        name: String,
        context: ChannelHandlerContext
    ) {
    ...
    public func writeResponseCompleted(context: ChannelHandlerContext) {
        let response = OpenResponsesResponse(
            id: responseId,
            createdAt: Int(Date().timeIntervalSince1970),
            status: .completed,
